...
public final class HexagonalView: UIScrollView {
    ...
    private func createHexagonalViewItem(index: Int) -> HexagonalItemView {
        ...
        if let image = hexagonalDataSource?.hexagonalView(hexagonalView:self, imageForIndex: index) {
    ...
    func transformView(view: HexagonalItemView) {
    ...
    func centerOnIndex(index: Int, zoomScale: CGFloat) {
    ...
    */
    ...
    static func closestIndexToContentViewCenter(contentViewCenter: CGPoint,currentIndex: Int,views: [UIView]) -> Int {
        var hasItem = false
